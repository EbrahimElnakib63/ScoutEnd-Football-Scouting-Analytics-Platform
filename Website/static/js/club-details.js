document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById('clubSeason').textContent = `${season}`;
    document.getElementById('clubLogo').src = `/static/imgs/logos/${encodeURIComponent(clubName.toLowerCase())}.webp`;
            ...
            if (players.length === 0) {
                ...
                const tableConfigs = [
                    ...
                    },
                    {
                        ...
                        columnName: 'Market Value',
                        formatValue: (value) => value + ' ' + 'm'
                    },
                    {
                        id: 'minutesPlayedTable',
                        sortKey: 'Playing_Time_Min',
